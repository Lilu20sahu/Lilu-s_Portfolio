...
copy.addEventListener("click", () => {
  navigator.clipboard.writeText("lilusahu1719@gmail.com");
...
//  CONTACT
  ...
  var messageArr = ["Mendix-Developer", "Frontend Developer", "Backend Developer"];
  var textPosition = 0;
  var speed = 200;

  typewriter = () => {
    //  i+for(let i = 0; i < messageArr.length;+) {
